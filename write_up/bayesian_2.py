...
def run_pymultinest(prior_range, model, GL_min, GL_max, n_params, directory,
                    ...
                    sampling_efficiency=0.3): # Reccomended for Bayesian evidence
...
if __name__ == "__main__":
  ...
  ## Standard fit - for posterior distribution (use large priors)
  alpha_range = [-0.2, 0.2]
  c_range = [-2, 2]
  f0_range = [-4, 4]
  f1_range = [-2, 2]
  ...
  analysis1 = run_pymultinest(prior_range, model27, GL_min, GL_max, n_params, directory, n_live_points=points, sampling_efficiency=0.8, clean_files=False)
  analysis2 = run_pymultinest(prior_range, model28, GL_min, GL_max, n_params, directory, n_live_points=points, sampling_efficiency=0.8, clean_files=False)
